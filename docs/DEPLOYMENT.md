# CHAMP POS — развёртывание и эксплуатация
...
2. Через несколько секунд снизу должен появиться баннер «Установить CHAMP POS» —
   нажмите «Установить». (Если баннер не появился сразу — откройте меню Chrome ⋮ →
   «Установить приложение».)
3. Иконка CHAMP появится на рабочем столе и в списке приложений — открывается как обычное
