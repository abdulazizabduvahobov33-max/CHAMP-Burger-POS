# KRUNCH POS — развёртывание и эксплуатация
...
2. Через несколько секунд снизу должен появиться баннер «Установить KRUNCH POS» —
   нажмите «Установить». (Если баннер не появился сразу — откройте меню Chrome ⋮ →
   «Установить приложение».)
3. Иконка KRUNCH появится на рабочем столе и в списке приложений — открывается как обычное
