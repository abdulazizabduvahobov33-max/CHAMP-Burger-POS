...
import { AlertTriangle, BarChart3, Bot, LayoutGrid, PackagePlus, Receipt, Settings, ShoppingBasket, ShoppingCart, TrendingUp, Truck, Users, Warehouse, type LucideIcon } from "lucide-react";
  ...
  return (
    <div className="min-h-full p-6 [padding-top:max(1.5rem,env(safe-area-inset-top))] [padding-left:max(1.5rem,env(safe-area-inset-left))] [padding-right:max(1.5rem,env(safe-area-inset-right))] [padding-bottom:max(1.5rem,env(safe-area-inset-bottom))]">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <DashboardCard to="/admin/tables" icon={LayoutGrid} title={t("dashboard.sections.tables.title")} subtitle={t("dashboard.sections.tables.subtitle")} />
