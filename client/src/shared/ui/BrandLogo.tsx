...
/** Primary KRUNCH wordmark — glyph + "KRUNCH" set in tight, heavy type, used in every page
 * header, the login card, and the dashboard. Pass `subtitle` for the login screen's tagline
 * under the wordmark. */
    ...
    <div className={`flex items-center gap-2.5 ${className}`}>
      ...
      <div className="leading-none">
        <span className={`font-extrabold tracking-tight text-white ${WORD_SIZE[size]}`}>
          KRUNCH<span className="text-champ">.</span>
        </span>
