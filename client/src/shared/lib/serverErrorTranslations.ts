...
const UZ_BY_RU: Record<string, string> = {
  ...
  "Исправления доступны только для оформленных продаж": "Tuzatishlar faqat rasmiylashtirilgan sotuvlar uchun mavjud",
  ...
  "Отменить можно только оформленную продажу": "Faqat rasmiylashtirilgan sotuvni bekor qilish mumkin",
  "Позиция не найдена": "Pozitsiya topilmadi",
  "Позиция уже удалена": "Pozitsiya allaqachon o'chirilgan",
  ...
  "Укажите новое количество или цену": "Yangi miqdor yoki narxni kiriting",
